...
feature_names_out = encodage.get_feature_names_out(input_features=X_cat.columns)
X_cat_encoded = encodage.transform(X_cat)  
X_cat_encoded_df = pd.DataFrame(X_cat_encoded, columns=feature_names_out, index=X.index)  
